...
LR_ACTOR = 1e-4         # learning rate of the actor,   benchmark: 1e-4
LR_CRITIC = 1e-4        # learning rate of the critic,  benchmark: 1e-4
WEIGHT_DECAY = 0.0     # L2 weight decay,               benchmark: 0
...
class Agent():
    ...
    def act(self, state, noise_scale, add_noise=False):
